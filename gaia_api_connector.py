                ...
                try:       
                    ...
                    while True:
                        ...
                        if show_task_text['tasks'][0]['progress-percentage'] == 100:
                            ...
                            #print (base64resp['tasks'][0]['task-details'][0]['output'])
...
class Interactive_Init_Handler():
    ...
    def validate_ip(ip:str) -> bool:
        ...
        try:
            ...
            check= False
            print ("IP validation failed!: {}".format(e))
            return check
            ...
            if args.user == None and args.password == None and args.version == None and args.path == None:
                ...
                if self.version == "single":
                    try:     
                        ...
                        print ("")
                        print ("#########################################")
                        print ("Modifiyng single node: {}".format(self.IP))
                        try:    
                    ...
                    try:  
                        ...
                        print ("")
                        print ("#########################################")
                        print ("Modifiyng node: {}".format(self.node1IP))
                        try:    
                        ...
                        print ("")
                        print ("#########################################")
                        print ("Modifiyng node: {}".format(self.node2IP))
                        try:    
                    ...
                    if self.version == "single":
                        if args.single == None:
                            ...
                            try:
                                ...
                                print ("")
                                print ("#########################################")
                                print ("Modifiyng node: {}".format(self.IP))
                                try: 
                                    Operate_CP(self.data['single'],self.connector).run()
                                except Exception as e:
